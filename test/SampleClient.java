...
public class SampleClient extends Mock implements Client
{
	...
	private SocketChannel client; //connection to order manager
	...
	public SampleClient()
	{
		...
		connect(new InetSocketAddress("localhost", 2025));
...
//	}
	...
	public void connect(InetSocketAddress serverSocket)
	{
...
//		SocketChannel client = null;
		while(tryCounter < 200)
		{
			try
			{
				this.client = SocketChannel.open(new InetSocketAddress("localhost", 2025));
	...
	public int sendRandomOrder() throws IOException
	{
		...
		String msg = "sendOrder: id="+id+" size="+size+" price="+price+" instrument="+INSTRUMENTS[instid].toString()+" side="+side;
...
//		}
	...
	@Override
	public int sendOrder(int id, int size, char msgType, float price, Instrument ins, int side)throws IOException{return 0;}
//	{
//        // Make a new order single
